...
const Add = {
   async render() {
      ...
      <form id="addForm" name="addForm">
         <div class="mb-3"><label for="">name</label> <input class=form-control id="pro_name" name="pro_name" placeholder="">
         </div>
         <div class="mb-3"><label for="">Price</label> <input class=form-control id="pro_price" name="pro_price"
            placeholder=""> </div>
         <div class="mb-3"><label for="">image</label> <input class=form-control id="pro_img" name="pro_img" placeholder="">
         </div>
         <div class="mb-3">
         ...
         <div class="mb-3"><label for="">desc</label> <input class="form-control" id="pro_desc" name="pro_desc"
            placeholder=""></div><button class="btn btn-primary" id="btnAdd">Submit</button>
      </form>
      `
   },
   afterRender() {
      ...
      formAdd.validate({
         ...
         submitHandler: () =>{
           ...
           axios.post("http://localhost:3001/products",pro)
